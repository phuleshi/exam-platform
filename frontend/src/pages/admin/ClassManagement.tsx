  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-md border border-slate-200 shadow-xs">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-2">
            <Users className="text-blue-700" size={28} /> Quản Lý Lớp Học (Quản Trị Viên)
          </h1>
          <p className="text-sm text-slate-500 mt-1">
            Khởi tạo lớp học, phân công giáo viên phụ trách và gán danh sách sinh viên tham gia lớp.
          </p>
        </div>
      ...
      <div className="p-3 bg-purple-50 border border-purple-200 rounded-md text-xs text-purple-900 flex items-center gap-2 font-medium">
        ...
        <span>Quyền Quản Trị Viên: Quyền độc quyền khởi tạo lớp học, gán giáo viên và phân bổ sinh viên vào từng lớp.</span>
      </div>
